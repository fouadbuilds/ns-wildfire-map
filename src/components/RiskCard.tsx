    ...
    >
      <div className="flex items-center justify-between gap-2">
        <div className="min-w-0">
          ...
          <p className="text-[10px] text-gray-400 uppercase tracking-widest mt-0.5">{location.region}</p>
        </div>
        <div className="flex items-center gap-2 shrink-0">
          ...
          <span className="text-xs text-gray-400 w-6 text-right">{risk.score}</span>
        </div>
      </div>
